...
export default function AnalyticsPage() {
  ...
  const handleExportCSV = () => {
    ...
    setTimeout(() => {
      ...
      link.href = url;
      link.setAttribute('download', `solar_analytics_report_${selectedRange.toLowerCase().replace(' ', '_')}.csv`);
